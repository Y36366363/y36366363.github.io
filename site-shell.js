...
(function() {
  ...
  const FOOTER_SOCIALS = [
    {
      href: 'https://github.com/Y36366363',
      label: 'GitHub',
    ...
    {
      href: 'https://www.linkedin.com/in/jialiang-yao-581310226',
      label: 'LinkedIn',
  ...
  function getFooterCopy() {
    ...
    if (getCurrentPage() === 'photography') {
      return '© 2026 Jialiang Yao. All photographs are original works.';
    }

    return '© 2026 Jialiang Yao';
  }
